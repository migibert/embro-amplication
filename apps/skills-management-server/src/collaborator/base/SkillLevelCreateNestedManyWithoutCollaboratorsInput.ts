...
@InputType()
class SkillLevelCreateNestedManyWithoutCollaboratorsInput {
...
export { SkillLevelCreateNestedManyWithoutCollaboratorsInput as SkillLevelCreateNestedManyWithoutCollaboratorsInput };
