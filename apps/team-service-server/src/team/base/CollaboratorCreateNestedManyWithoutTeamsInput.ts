...
@InputType()
class CollaboratorCreateNestedManyWithoutTeamsInput {
...
export { CollaboratorCreateNestedManyWithoutTeamsInput as CollaboratorCreateNestedManyWithoutTeamsInput };
